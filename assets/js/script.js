...
function generatePassword() {  passwordLength = prompt("Please choose between 8 and 128 characters for your password");
  ...
  if(!passwordLength) {
    ...
    passwordLength = prompt("Please pick a number between 8 and 128 for desired password length");
    console.log("Password length " + passwordLength);
